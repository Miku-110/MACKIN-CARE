...
import doctorImage from 'D:/Kuliah/Magang/project1/MACKIN-CARE1/src/assets/dokter.jpg';
// --- SVG Icon Components ---
            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-8">
                ...
                <p className="mt-3 text-slate-600">
                  Welcome Doctor! Please enter your details.
                </p>
              </div>
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <Link  to="/dokter/dashboard" className="w-full sm:w-auto px-10 py-3 font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                    Log in
                  </Link>
